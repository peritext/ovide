/**
 * This module exports logic-related elements for the section view
...
export const SET_PRODUCTION_IS_SAVED = 'SET_PRODUCTION_IS_SAVED';
...
export const setProductionIsSaved = ( payload ) => ( {
  type: SET_PRODUCTION_IS_SAVED,
  payload,
} );
...
export const setInternalLinkModalFocusData = ( payload ) => ( {
  type: SET_INTERNAL_LINK_MODAL_FOCUS_DATA,
  payload,
} );
...
export const setPreviewMode = ( payload ) => ( {
...
const productionIsSaved = ( state ) => state.ui.productionIsSaved;
